...
export const mapXYZUrl = {
  ...
  tiandi_img_single: `http://t0.tianditu.gov.cn/DataServer?T=img_w&x={x}&y={y}&l={z}&tk=${tiandituKey}`,
  tiandi_img_roadLabel_single: `http://t0.tianditu.gov.cn/DataServer?T=cta_w&x={x}&y={y}&l={z}&tk=${tiandituKey}`,
  tiandi_img_label_single: `http://t0.tianditu.gov.cn/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=${tiandituKey}`,
  tiandi_img_vec_single: `http://t0.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=${tiandituKey}`,
  tiandi_img_ter_single: `http://t0.tianditu.gov.cn/DataServer?T=ter_w&x={x}&y={y}&l={z}&tk=${tiandituKey}`,
  /***
   *geoq地图
