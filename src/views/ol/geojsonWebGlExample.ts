...
import geojsonWebGlLayers from "@/utils/map/ol/geojsonWebGlLayers";
...
export default class OlMapGeojsonHelper extends OlBase {
  ...
  public GeojsonMapIns: geojsonWebGlLayers | null = null;
  ...
  constructor(target: string, pixelRatio = 2) {
    ...
    this.GeojsonMapIns = new geojsonWebGlLayers(this);
