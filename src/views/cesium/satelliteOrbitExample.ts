...
import CsSatelliteOrbitLayers from "@/utils/map/cesium/satelliteOrbitLayers";
import type { SatelliteOrbitOptions } from "@/utils/map/cesium/satelliteOrbitLayersTypes";
...
export default class CsMapHelper extends CsBase {
  ...
  public csOrbitIns: CsSatelliteOrbitLayers | null = null;
  ...
  constructor(target: string, csBasicOptions: CesiumBasicOptions) {
    ...
    this.csOrbitIns = new CsSatelliteOrbitLayers(this);
  }
  ...
  public addSatelliteOrbit(orbitOptions: SatelliteOrbitOptions) {
    if (this.csOrbitIns) {
